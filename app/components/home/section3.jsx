...
const SplitSection = () => {
  ...
  return (
    <>
      <Head>
        <title>Corporate and Social Event Solutions | Carousel</title>
        <meta
          name="description"
          content="We specialize in experiential events that elevate brands into popular culture and create shareworthy moments."
        />
        <meta
          name="keywords"
          content="Corporate Events, Social Events, Experiential Events, Brand Activation, Carousel"
        />
          ...
          <div className="social-grid flex flex-col justify-center pt-5 items-center pb-5 px-10 lg:px-0  bg-peachy lg:bg-transparent md:items-start text-center md:text-left ">
            <div className="text-center max-w-xs md:max-w-md lg:mt-20">
              ...
              <p className="mb-8 text-lg text-gray-600 ">
                ...
                off, Carousel is your answer. From unique creations to
                execution, we combine seasoned knowledge with inspiration.
                Don&apos;t settle for boring standard eventing.
              </p>
              {/* <button className="btn-hover-effect bg-black text-white px-6 py-3 rounded-full font-semibold relative overflow-hidden">
              <span className="relative z-10">LEARN MORE</span>
            </button> */}
